...
TRAIN_FILE="data/02_annotate/Llama-3.1-8B-Instruct/prm_annotated_1M_no_trigger.jsonl"
OUTPUT_DIR="models/prm_1.5b_llama_raw_only_no_trigger"  # 名前をわかりやすく変更
RUN_NAME="prm_1.5b_llama_raw_only_no_trigger"
