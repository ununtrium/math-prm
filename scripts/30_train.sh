...
TRAIN_FILE="data/prm_train_ensemble_1M_no_trigger.jsonl"
OUTPUT_DIR="models/prm_1.5b_ensemble_raw_only_no_trigger"  # 名前をわかりやすく変更
RUN_NAME="prm_1.5b_ensemble_raw_only_no_trigger"
