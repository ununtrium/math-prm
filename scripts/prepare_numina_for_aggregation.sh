...
BENCHMARKS="numina_train"  # 対象ベンチマーク
SEEDS="42"                       # シード
NUM_SAMPLES=16                      # サンプル数
...
SCRIPT_PATH="src/prepare_numina_for_aggregation.py"
...
python3 ${SCRIPT_PATH} \
    ...
    >& "${HOME_DIR}/log/gen_qwen_1.5b_train.log"
